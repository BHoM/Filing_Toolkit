...
namespace BH.Engine.Filing
{
    public static partial class Query
    {
        ...
        public static string ContentsAsString(this FileInfo file, Encodings encoding = Encodings.FromFile)
        {
        ...
        [Input("file", "The file to get the contents of.")]
        [Output("The contents of the file.")]
        public static byte[] ContentsAsByteArray(this FileInfo bhomFile)
        {
            byte[] contents = null;
